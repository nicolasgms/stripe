...
<html lang="fr">
    ...
    <body>
        ...
        <div class="form">
            ...
            <center><h3>Informations bancaire</h3></center>
            <form method="post">
                ...
                <button id="card-button" type="button" data-secret="<?= $intent['client_secret'] ?>">Valider et payer</button>
            </form>
        </div>
