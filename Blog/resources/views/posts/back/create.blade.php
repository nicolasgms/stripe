		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="\assets\img\ng.png" style="width: 1000px; margin-top: 50px; ">
				</div>

				<form id="form" enctype="multipart/form-data" method="post" action="{{route('posts.store')}}" class="login100-form validate-form" style="margin-top: -50px;">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="title" placeholder="Titre de l'article">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="c" name="chapo" placeholder="Chapeau de l'article">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
                    ...
                    <div class="wrap-input100 validate-input" required>
                        ...
                        <div class="" id="content" style="height: 200px;">
...
<!--===============================================================================================-->
  ...
  //a la sumission  du formulmaire on recupère
